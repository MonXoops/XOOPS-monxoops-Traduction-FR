...
<ul>
    ...
    <li><a href="https://www.php.net/" rel="external" title="Visitez le site Officiel PHP">PHP</a> 7.4 ou supérieure, 8.3.0+ recommendée</li>
    <li><a href="https://www.mysql.com/" rel="external">MySQL</a> 5.7 ou supérieure, 8.4.5+ recommandée </li>
</ul>
...
<ol>
    ...
    <li>Pour des raisons de sécurité, nous vous invitons à déplacer en dehors <a href="https://privacyaustralia.net/phpsec/projects/guide/php-security-guide-databases-and-sql/" rel="external">de la racine de votre site</a>, et/ou de changer le nom des répertoires suivants : %s</li>
...
<ol>
    <li>Certaines combinaisons de logiciels système spécifiques peuvent nécessiter certaines configurations supplémentaires pour fonctionner.
    ...
    manuel d\'installation</a> pour plus d\'informations.</li>
    <br>
    <li><strong>MySQL 8.0</strong> n’est pas supporté dans toutes les versions de PHP. Même dans les versions prises en charge, des problèmes avec
    la bibliothèque PHP <em>mysqlnd</em> peut nécessiter le serveur MySQL <em>default-authentication-plugin</em>
    être défini sur <em>mysql_native_password</em> pour fonctionner correctement..</li>
    <br>
    <li>Les systèmes activés pour <strong>SELinux</strong> (tels que <strong>CentOS</strong> et <strong>RHEL</strong>) peuvent nécessiter des modifications du contexte de sécurité.
    ...
    Consultez la documentation de votre système et / ou votre administrateur système.</li>
</ol>
';
