...
define('_AD_EDIT', 'Éditer');
define('_AD_DELETE', 'Supprimer');
...
define('_AD_WARNING_OLD_PHP', 'AVERTISSEMENT: Pensez à passer à une version plus récente de PHP. La version %s ou plus récente est recommandée et sera nécessaire dans les futures versions de XOOPS.');
